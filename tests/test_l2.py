...
from src.l2_control_gateway import (
    ...
    RateLimitExceeded, AuthenticationError, ForbiddenError
)
...
class TestControlGateway:
    ...
    def test_authentication_failure(self):
        ...
        # Mock authenticator to reject
        with patch.object(gateway.authenticator, 'verify_token') as mock_verify:
    ...
    def test_permission_validation(self):
        ...
        # Mock to return guest permissions
        with patch.object(gateway.authenticator, 'get_user_permissions') as mock_perm:
            mock_perm.return_value = ["guest"]
